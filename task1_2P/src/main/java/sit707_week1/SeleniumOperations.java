...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from Student ID: 220437608, Gnei Azmah Kitchilan");
		 ...
		 */
		// write code
		Dimension dimension640x480 = new Dimension(640, 480);
	    driver.manage().window().setSize(dimension640x480);
		 ...
		 */
		// write code
	    Dimension dimension1280x960 = new Dimension(1280, 960);
	    driver.manage().window().setSize(dimension1280x960);
